...
namespace BOM_CLASS
{
    ...
    public partial class AutomationEntitiesBOM : DbContext
    {
        public AutomationEntitiesBOM()
            : base("name=AutomationEntitiesBOM")
        {
        }
        ...
        public virtual DbSet<Dependability> Dependabilities { get; set; }
